...
namespace KmsReportClient.Report.Basic
{
    public class ReportCadreProcessor : AbstractReportProcessor<ReportCadre>
    {
        ...
        private readonly List<string> zpz_ekmp = new List<string>
        {
            ...
            "в том числе:;из них заняты на Х ставок:; Х > 1,0;15",
            "в том числе:;из них заняты на Х ставок:; Х = 1,0;16",
            "в том числе:;из них заняты на Х ставок:; Х < 1,0;Х = 0,75;17",
            "в том числе:;из них заняты на Х ставок:; Х < 1,0;Х = 0,5 (0,6);18",
            "в том числе:;из них заняты на Х ставок:; Х < 1,0;Х = 0,25;19",
            "в том числе:;из них заняты на Х ставок:; Х < 1,0;X <= 0,1;20",
            "в том числе:;Врачи-эксперты качества МП (вх. в реестр врачей-экспертов ФОМС), занятые на ставку X:; Х > 1,0;21",
            "в том числе:;Врачи-эксперты качества МП (вх. в реестр врачей-экспертов ФОМС), занятые на ставку X:; Х = 1,0;22",
            "в том числе:;Врачи-эксперты качества МП (вх. в реестр врачей-экспертов ФОМС), занятые на ставку X:; Х < 1,0;Х = 0,75;23",
            "в том числе:;Врачи-эксперты качества МП (вх. в реестр врачей-экспертов ФОМС), занятые на ставку X:; Х < 1,0;Х = 0,5 (0,6);24",
            "в том числе:;Врачи-эксперты качества МП (вх. в реестр врачей-экспертов ФОМС), занятые на ставку X:; Х < 1,0;Х = 0,25;25",
            "в том числе:;Врачи-эксперты качества МП (вх. в реестр врачей-экспертов ФОМС), занятые на ставку X:; Х < 1,0;X <= 0,1;26",
