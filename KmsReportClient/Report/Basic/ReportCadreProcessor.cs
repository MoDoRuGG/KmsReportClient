...
namespace KmsReportClient.Report.Basic
{
    public class ReportCadreProcessor : AbstractReportProcessor<ReportCadre>
    {
        ...
        {
            "Id",
            "Численность,всего;по штату;3",
            "Численность,всего;факт;4",
            "Численность,всего;вакансии;5",
            "в том числе:;Руководитель;по штату;6",
            "в том числе:;Руководитель;факт;7",
            "в том числе:;Руководитель;вакансии;8",
            "в том числе:;Заместитель руководителя;по штату;9",
            "в том числе:;Заместитель руководителя;факт;10",
            "в том числе:;Заместитель руководителя;вакансии;11",
            "в том числе:;Врачи-эксперты (исключая руководство);по штату;12",
            "в том числе:;Врачи-эксперты (исключая руководство);факт;13",
            "в том числе:;Врачи-эксперты (исключая руководство);вакансии;14",
            "в том числе:;из них (из гр.13) заняты на Х ставок:гр.(15+16+17+18+19+20) = гр.13; Х > 1,0;15",
            "в том числе:;из них (из гр.13) заняты на Х ставок:гр.(15+16+17+18+19+20) = гр.13; Х = 1,0;16",
            "в том числе:;из них (из гр.13) заняты на Х ставок:гр.(15+16+17+18+19+20) = гр.13; Х < 1,0;Х = 0,75;17",
            "в том числе:;из них (из гр.13) заняты на Х ставок:гр.(15+16+17+18+19+20) = гр.13; Х < 1,0;Х = 0,5 (0,6);18",
            "в том числе:;из них (из гр.13) заняты на Х ставок:гр.(15+16+17+18+19+20) = гр.13; Х < 1,0;Х = 0,25;19",
            "в том числе:;из них (из гр.13) заняты на Х ставок:гр.(15+16+17+18+19+20) = гр.13; Х < 1,0;X <= 0,1;20",
            "в том числе:;Врачи-эксперты качества МП (вх. в реестр врачей-экспертов ФОМС), занятые на ставку X (из гр. 13):; Х > 1,0;21",
            "в том числе:;Врачи-эксперты качества МП (вх. в реестр врачей-экспертов ФОМС), занятые на ставку X (из гр. 13):; Х = 1,0;22",
            "в том числе:;Врачи-эксперты качества МП (вх. в реестр врачей-экспертов ФОМС), занятые на ставку X (из гр. 13):; Х < 1,0;Х = 0,75;23",
            "в том числе:;Врачи-эксперты качества МП (вх. в реестр врачей-экспертов ФОМС), занятые на ставку X (из гр. 13):; Х < 1,0;Х = 0,5 (0,6);24",
            "в том числе:;Врачи-эксперты качества МП (вх. в реестр врачей-экспертов ФОМС), занятые на ставку X (из гр. 13):; Х < 1,0;Х = 0,25;25",
            "в том числе:;Врачи-эксперты качества МП (вх. в реестр врачей-экспертов ФОМС), занятые на ставку X (из гр. 13):; Х < 1,0;X <= 0,1;26",
