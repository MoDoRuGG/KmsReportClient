...
{
    class ReportZpzLethalProcessor : AbstractReportProcessor<ReportZpz>
    {
        ...
        public override void ToExcel(string filename, string filialName)
        {
            ...
            var excel = new ExcelZpzLethalCreator(filename, ExcelForm.ZpzLethal, mm, filialName);
        ...
        private void FillDgwForms1(DataGridView dgvReport, string form)
        {
            ...
            foreach (DataGridViewRow row in dgvReport.Rows)
            {
                ...
                var yearThemeData = Client.GetZpzLethalYearData(new GetZpzLethalYearDataRequest(new GetZpzLethalYearDataRequestBody
                {
                    fillial = FilialCode,
                    theme = form,
                    yymm = Report.Yymm,
                    rowNum = rowNum
                })).Body.GetZpzLethalYearDataResult;
