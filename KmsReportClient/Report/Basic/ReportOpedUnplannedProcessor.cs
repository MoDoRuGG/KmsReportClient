...
namespace KmsReportClient.Report.Basic
{
    public class ReportOpedUnplannedProcessor : AbstractReportProcessor<ReportOpedU>
    {
        ...
        public ReportOpedUnplannedProcessor(EndpointSoap inClient, List<KmsReportDictionary> reportsDictionary, DataGridView dgv, ComboBox cmb, TextBox txtb, TabPage page) :
           base(inClient, dgv, cmb, txtb, page,
               XmlFormTemplate.OpedUnplanned.GetDescription(),
               Log,
        ...
        {
            var excel = new ExcelOpedUnplannedCreator(filename, ExcelForm.OpedUnpl, Report.Yymm, filialName);
