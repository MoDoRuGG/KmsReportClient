...
{
    class ExcelConsolidateCadreT2Creator : ExcelBaseCreator<CReportCadreTable2[]>
    {
        private const int StartPosition = 7;

        public ExcelConsolidateCadreT2Creator(
            string filename,
            string header,
            string filialName) : base(filename, ExcelForm.CCadreT2, header, filialName, false) { }

        protected override void FillReport(CReportCadreTable2[] report, CReportCadreTable2[] yearReport)
        {
