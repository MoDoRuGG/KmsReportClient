...
{
    public class ExcelConsolidateZpzTable10FilialGrowCreator : ExcelBaseCreator<ConsolidateZpzTable10Filial[]>
    {
        ...
        protected override void FillReport(ConsolidateZpzTable10Filial[] report, ConsolidateZpzTable10Filial[] yearReport)
        {
            ...
            foreach (var data in report)
            {
                ...
                ObjWorkSheet.Cells[currentIndex, 92] = data._75;
                ...
                ObjWorkSheet.Cells[currentIndex, 96] = "X";
                ObjWorkSheet.Cells[currentIndex, 97] = "X";
                ObjWorkSheet.Cells[currentIndex, 98] = "X";
                ObjWorkSheet.Cells[currentIndex, 99] = "X";
                ObjWorkSheet.Cells[currentIndex, 100] = "X";
                ObjWorkSheet.Cells[currentIndex, 101] = "X";
                ObjWorkSheet.Cells[currentIndex, 102] = "X";
