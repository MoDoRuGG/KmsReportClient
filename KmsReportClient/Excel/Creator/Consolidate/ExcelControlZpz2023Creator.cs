    ...
    class ExcelControlZpz2023Creator : ExcelBaseCreator<CReportZpz2023[]>
    {
        ...
        private void FillExpertises(CReportZpz2023[] reports)
        {
            ...
            foreach (var data in expertises)
            {
                ...
                ObjWorkSheet.Cells[currentIndex, 3] = data.Expertise.CountMee;
                ObjWorkSheet.Cells[currentIndex, 4] = data.Expertise.CountMeeComplaint;
                ObjWorkSheet.Cells[currentIndex, 5] = data.Expertise.CountMeeRepeat;
                ObjWorkSheet.Cells[currentIndex, 6] = data.Expertise.CountMeeOnco;
                ObjWorkSheet.Cells[currentIndex, 7] = data.Expertise.CountMeeDs;
                ObjWorkSheet.Cells[currentIndex, 8] = data.Expertise.CountMeeLeth;
                ObjWorkSheet.Cells[currentIndex, 9] = data.Expertise.CountMeeInjured;
                ObjWorkSheet.Cells[currentIndex, 10] = data.Expertise.CountMeeDefectedCase;
                ObjWorkSheet.Cells[currentIndex, 11] = data.Expertise.CountMeeDefects;
                ObjWorkSheet.Cells[currentIndex, 12] = data.Expertise.CountMeeDefectsPeriod;
                ObjWorkSheet.Cells[currentIndex, 13] = data.Expertise.CountMeeDefectsCondition;
                ObjWorkSheet.Cells[currentIndex, 14] = data.Expertise.CountMeeDefectsRepeat;
                ObjWorkSheet.Cells[currentIndex, 15] = data.Expertise.CountMeeDefectsOutOfDocums;
                ObjWorkSheet.Cells[currentIndex, 16] = data.Expertise.CountMeeDefectsUnpayable;
                ObjWorkSheet.Cells[currentIndex, 17] = data.Expertise.CountMeeDefectsBuyMedicament;
                ObjWorkSheet.Cells[currentIndex, 18] = data.Expertise.CountMeeDefectsOutOfLeth;
                ObjWorkSheet.Cells[currentIndex, 19] = data.Expertise.CountMeeDefectsWithoutDocums;
                ObjWorkSheet.Cells[currentIndex, 20] = data.Expertise.CountMeeDefectsIncorrectDocums;
                ObjWorkSheet.Cells[currentIndex, 21] = data.Expertise.CountMeeDefectsBadDocums;
                ObjWorkSheet.Cells[currentIndex, 22] = data.Expertise.CountMeeDefectsBadDate;
                ObjWorkSheet.Cells[currentIndex, 23] = data.Expertise.CountMeeDefectsBadData;
                ObjWorkSheet.Cells[currentIndex, 24] = data.Expertise.CountMeeDefectsOutOfProtocol;
                ObjWorkSheet.Cells[currentIndex, 25] = data.Expertise.CountCaseEkmp;
                ObjWorkSheet.Cells[currentIndex, 26] = data.Expertise.CountCaseEkmpComplaint;
                ObjWorkSheet.Cells[currentIndex, 27] = data.Expertise.CountCaseEkmpLeth;
                ObjWorkSheet.Cells[currentIndex, 28] = data.Expertise.CountCaseEkmpByMek;
                ObjWorkSheet.Cells[currentIndex, 29] = data.Expertise.CountCaseEkmpByMee;
                ObjWorkSheet.Cells[currentIndex, 30] = data.Expertise.CountCaseEkmpUTheme;
                ObjWorkSheet.Cells[currentIndex, 31] = data.Expertise.CountCaseEkmpMulti;
                ObjWorkSheet.Cells[currentIndex, 32] = data.Expertise.CountCaseEkmpMultiLeth;
                ObjWorkSheet.Cells[currentIndex, 33] = data.Expertise.CountCaseEkmpMultiUtheme;
                ObjWorkSheet.Cells[currentIndex, 34] = data.Expertise.CountCaseDefectedBySmo;
                ObjWorkSheet.Cells[currentIndex, 35] = data.Expertise.CountEkmpDefectedCase;
                ObjWorkSheet.Cells[currentIndex, 36] = data.Expertise.CountEkmpBadDs;
                ObjWorkSheet.Cells[currentIndex, 37] = data.Expertise.CountEkmpBadDsNotAffected;
                ObjWorkSheet.Cells[currentIndex, 38] = data.Expertise.CountEkmpBadDsProlonger;
                ObjWorkSheet.Cells[currentIndex, 39] = data.Expertise.CountEkmpBadDsDecline;
                ObjWorkSheet.Cells[currentIndex, 40] = data.Expertise.CountEkmpBadDsInjured;
                ObjWorkSheet.Cells[currentIndex, 41] = data.Expertise.CountEkmpBadDsLeth;
                ObjWorkSheet.Cells[currentIndex, 42] = data.Expertise.CountEkmpBadMed;
                ObjWorkSheet.Cells[currentIndex, 43] = data.Expertise.CountEkmpUnreglamentedMed;
                ObjWorkSheet.Cells[currentIndex, 44] = data.Expertise.CountEkmpStopMed;
                ObjWorkSheet.Cells[currentIndex, 45] = data.Expertise.CountEkmpContinuity;
                ObjWorkSheet.Cells[currentIndex, 46] = data.Expertise.CountEkmpUnprofile;
                ObjWorkSheet.Cells[currentIndex, 47] = data.Expertise.CountEkmpUnfounded;
                ObjWorkSheet.Cells[currentIndex, 48] = data.Expertise.CountEkmpRepeat;
                ObjWorkSheet.Cells[currentIndex, 49] = data.Expertise.CountEkmpDifference;
                ObjWorkSheet.Cells[currentIndex, 50] = data.Expertise.CountEkmpUnfoundedMedicaments;
                ObjWorkSheet.Cells[currentIndex, 51] = data.Expertise.CountEkmpUnfoundedReject;
                ObjWorkSheet.Cells[currentIndex, 52] = data.Expertise.CountEkmpDisp;
                ObjWorkSheet.Cells[currentIndex, 53] = data.Expertise.CountEkmpRepeat2weeks;
                ObjWorkSheet.Cells[currentIndex, 54] = data.Expertise.CountEkmpOutOfResults;
                ObjWorkSheet.Cells[currentIndex++, 55] = data.Expertise.CountEkmpDoubleHospital;
