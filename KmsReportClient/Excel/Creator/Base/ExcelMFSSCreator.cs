...
{
    public class ExcelMFSSCreator : ExcelBaseCreator<ReportFSSMonitroing>
    {
        Dictionary<string, DataGridViewRow> _rows;

        public ExcelMFSSCreator(
          string filename,
        ...
        protected override void FillReport(ReportFSSMonitroing report, ReportFSSMonitroing yearReport)
        {
