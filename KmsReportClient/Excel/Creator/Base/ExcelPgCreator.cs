...
{
    class ExcelPgCreator : ExcelBaseCreator<ReportPg>
    {
        ...
        protected override void FillReport(ReportPg report, ReportPg yearReport)
        {
            ...
            {
                var dict = _pgDictionaries.Single(x => x.TableName == themeData.Theme);
        ...
        private void FillTable12(ReportPgDataDto[] data, int startRowIndex, int endRowIndex, string theme)
        {
        ...
        private void FillTable1(ReportPgDataDto[] data, int startRowIndex, int endRowIndex, string form)
        {
        ...
        private void FillTable68(ReportPgDataDto[] data, int startRowIndex, int endRowIndex)
        {
            for (int i = startRowIndex; i <= endRowIndex; i++)
            {
                string rowNum = ObjWorkSheet.Cells[i, 2].Text;
