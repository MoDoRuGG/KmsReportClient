...
{
    public class ExcelDoffCreator : ExcelBaseCreator<ReportDoff>
    {
        private string _yymm;
        public ExcelDoffCreator(
      string filename,
      ...
      string filialName, string yymm) : base(filename, reportName, header, filialName, false)
        ...
        protected override void FillReport(ReportDoff report, ReportDoff yearReport)
        {
