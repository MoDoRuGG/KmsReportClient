...
{
    public partial class T7OldPolisYearlyDictionaryForm : Form
    {

        private readonly EndpointSoap _client;
        public T7OldPolisYearlyDictionaryForm(EndpointSoap client)
        {
            InitializeComponent();
            _client = client;
        ...
        private void CreateDataGridView()
        {
            ...
            //Console.WriteLine(CultureInfo.CurrentCulture.Name);
                ...
                dgvDictionary.Columns.Add(new DataGridViewTextBoxColumn
                {
                    HeaderText = "На 1 января " + GetYear(),
                    Name = year + "01",
        ...
        private void FillDataGridView()
        {
            ...
            {
                string year = GetYear();
                var data = _client.GetT7OldPolisYearlyList(new GetT7OldPolisYearlyListRequest
                {
                    Body = new GetT7OldPolisYearlyListRequestBody
                    {
                        year = year
                    }
                }).Body.GetT7OldPolisYearlyListResult;
        ...
        private void Save()
        {
            try
            {
                ...
                List<T7OldPolisYearlyDictionaryItem> requestData = new List<T7OldPolisYearlyDictionaryItem>();
                foreach (DataGridViewRow row in dgvDictionary.Rows)
                {
                    foreach (DataGridViewColumn column in dgvDictionary.Columns)
                    {
                        ...
                        requestData.Add(new T7OldPolisYearlyDictionaryItem
                        {
                ...
                _client.SaveT7OldPolisYearlyList(new SaveT7OldPolisYearlyListRequest { Body = new SaveT7OldPolisYearlyListRequestBody { plans = requestData.ToArray() } });
