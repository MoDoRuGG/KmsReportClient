...
{
    public partial class OpedFinanceDictionaryForm : Form
    {

        private readonly EndpointSoap _client;
        public OpedFinanceDictionaryForm(EndpointSoap client)
        {
            InitializeComponent();
            _client = client;
        ...
        private void FillDataGridView()
        {
            ...
            {
                string year = GetYear();
                var data = _client.GetOpedFinanceList(new GetOpedFinanceListRequest
                {
                    Body = new GetOpedFinanceListRequestBody
                    {
                        year = year
                    }
                }).Body.GetOpedFinanceListResult;
        ...
        private void Save()
        {
            try
            {
                ...
                List<OpedFinancePlanDictionaryItem> requestData = new List<OpedFinancePlanDictionaryItem>();
                foreach (DataGridViewRow row in dgvDictionary.Rows)
                {
                    foreach (DataGridViewColumn column in dgvDictionary.Columns)
                    {
                        ...
                        requestData.Add(new OpedFinancePlanDictionaryItem
                        {
                ...
                _client.SaveOpedFinanceList(new SaveOpedFinanceListRequest { Body = new SaveOpedFinanceListRequestBody { plans = requestData.ToArray() } });
